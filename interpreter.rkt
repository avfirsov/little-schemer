...
;*application ((lambda (x cb)(cb (add1 x))) 42 add1)
; => (non-primitive () (x cb) (cb (add1 x)) && (42 (primitive add1)) => apply => apply-closure => (cb (add1 x)) (( (x cb) (42 (primitive value)) ), ...existingTable) =>
; => meaning
